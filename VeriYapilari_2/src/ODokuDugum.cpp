...
ODokuDugum::ODokuDugum() // Düğüm oluşturma (ilk etapta içinde herhangi bir yapı olmadığı için adres kısmı 0 olarak belirlendi)
{
    dokuAdres = 0;
    sonraki = 0;
}

ODokuDugum::~ODokuDugum() // oluşturulan düğümü içinde yer alacak olan doku yapısını silme
{
    delete dokuAdres;
}